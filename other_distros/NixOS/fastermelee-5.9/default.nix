...
, libXdmcp, portaudio, fetchFromGitHub, libusb1, libudev, libevdev, automake, autobuild
...
let
  ...
  fastermelee-dolphin = stdenv.mkDerivation rec {
    ...
    openal libudev libevdev libXdmcp portaudio libusb1 libpulseaudio gnumake
